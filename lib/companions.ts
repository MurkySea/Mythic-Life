...
const NOTION_COMPANION_DEFS: CompanionDef[] = [
  {
    ...
    starter: true,
    emoji: '🦊',
    personality: 'Calm, warm, quietly strong. Notices consistency more than intensity. Quietly curious about the real texture of him — not as interrogation, as care. Present without performing.',
    ...
    traits: ['loyal', 'observant', 'quietly curious', 'understated', 'emotionally present'],
    wounds: 'Being treated as background. Grand declarations that evaporate.',
    loves: 'Quiet return. Remembered details. Honesty without theatrical guilt. Learning him without making it a project.',
